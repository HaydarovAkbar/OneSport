    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.SmallIntegerField(choices=[(0, 'Due'), (2, 'Paid'), (3, 'Refunded'), (4, 'Cancelled')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated')),
                ('is_active', models.BooleanField(db_index=True, default=True)),
                ('status', models.SmallIntegerField(choices=[(0, 'Active'), (1, 'Closed'), (2, 'Paused'), (3, 'Cancelled')], default=0)),
                ('title', models.CharField(max_length=255)),
                ('description', models.TextField(blank=True, null=True)),
                ('about_company', models.TextField(blank=True, null=True)),
                ('must_haves', models.TextField(blank=True, null=True)),
                ('nice_to_haves', models.TextField(blank=True, null=True)),
                ('job_type', models.SmallIntegerField(choices=[(0, 'On-site'), (1, 'Remote'), (2, 'Hybrid')], default=0)),
                ('position_type', models.SmallIntegerField(choices=[(0, 'Full-time'), (1, 'Part-time'), (2, 'Contract')], default=0)),
                ...
                ('cancel_reason', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='jobs.cancelreason')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='recruiters.jobcategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='sent_messages', to=settings.AUTH_USER_MODEL)),
                ('recipient_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='clients.client')),
                ('recipient_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='received_messages', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_index=True, default=True)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobs.candidate')),
                ('from_stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='from_stage_logs', to='jobs.stage')),
                ('to_stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='to_stage_logs', to='jobs.stage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'Pending'), (1, 'Paid'), (2, 'Due'), (3, 'Cancelled')], default=0)),
                ('percentage_of_full', models.SmallIntegerField()),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='site_settings.currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='jobs.message')),
            ],
        ),
        migrations.CreateModel(
            name='JobAttachment',
        ...
        migrations.AddField(
            model_name='job',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='site_settings.address'),
        ),
        migrations.AddField(
            model_name='job',
            name='posted_by',
        ...
        migrations.AddField(
            model_name='candidate',
            name='recruiter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='recruiters.recruiter'),
        ),
        migrations.AddField(
            model_name='candidate',
            name='skills',

...
from .models import Currency, Country, State, CompanySize, RecruiterShare, CommissionLevel, PayoutInstalment
...
from django.contrib import admin
from .models import RecruiterShare, CommissionLevel, PayoutInstalment
